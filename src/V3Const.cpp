...
void V3Const::constifyAllLint(AstNetlist* nodep) {
    ...
    V3Global::dumpCheckGlobalTree("const.tree", 0,  v3Global.opt.dumpTreeLevel(__FILE__) > 2);
}
...
void V3Const::constifyCpp(AstNetlist* nodep) {
    ...
    (void)visitor.mainAcceptEdit(nodep);
    V3Global::dumpCheckGlobalTree("const_cpp.tree", 0, v3Global.opt.dumpTreeLevel(__FILE__) > 2);
}
