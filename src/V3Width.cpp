...
void V3Width::width(AstNetlist* nodep) {
    ...
    V3Global::dumpCheckGlobalTree("width.tree", 0,  v3Global.opt.dumpTreeLevel(__FILE__) > 2);
}
...
void V3Width::widthCommit(AstNetlist* nodep) {
    ...
    V3Global::dumpCheckGlobalTree("widthcommit.tree", 0,  v3Global.opt.dumpTreeLevel(__FILE__) > 5);
}
